...
<div class="row mt-4 mb-4  justify-content-center">
  <div class="col-md-10">
    <h3 class="float-left"><i class="fas fa-snowplow"></i> Caratula Ingreso </h3>
  </div>
</div>


<form class="form-horizontal" action="{{ route('ingresodoc.store') }}" method="POST" enctype="multipart/form-data">
@csrf
<div class="row mt-4 mb-4  justify-content-center">
  <div class="col-md-8">
