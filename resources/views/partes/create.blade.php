...
<form class="form-horizontal" action="{{ route('partes.store') }}" method="POST" enctype="multipart/form-data">
@csrf
<div class="row mt-4 mb-4  justify-content-center">
  <div class="col-md-8">
         ...
         <div class="col-md-12">
            ...
            <div class="col-md-12">
              ...
              <div class="input-group mb-2">
                ...
                <textarea type="text" class="form-control" id="materia"  name="materia" maxlength="500"  value="{{ old('materia') }}" ></textarea>
              </div>           
              </div>
